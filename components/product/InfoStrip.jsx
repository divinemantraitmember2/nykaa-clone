...
export default function InfoStrip() {
  return (
    <div className="w-full bg-white py-3 px-1 sm:px-2 md:px-2">
      ...
      <div className="flex gap-4 overflow-x-auto sm:grid sm:grid-cols-2 md:grid-cols-3 sm:gap-6 max-w-6xl mx-auto scroll-smooth snap-x snap-mandatory sm:overflow-visible">
        {items.map((item, idx) => (
          <div
            key={idx}
            className="min-w-[230px] sm:min-w-0 shrink-0 snap-start group bg-white p-2 flex flex-col items-center text-center border border-gray-200 rounded-lg transition hover:shadow-md hover:-translate-y-1 duration-300"
          >
            <div className="mb-4">
              <Image
                src={item.src}
