        ...
        <div className="flex gap-4 w-max">
          {loading ? (
            ...
            coupons.map((coupon) => (
              <div
                key={coupon.id}
                className="relative w-[300px] min-h-[150px] bg-gradient-to-br from-pink-50 to-white border border-gray-200 rounded-xl  flex flex-col justify-between transition duration-300 overflow-hidden"
              >
                {/* Top Section */}
                <div className="p-4">
