  ...
  return (
    <section className=" ">
      <div className="mb-5 lg:mb-10 bg-white">
        ...
        <div className="flex gap-4 w-full lg:w-[50%] p-2">
          {/* Thumbnails */}
        ...
        {/* Product Info */}
        <div className="w-full lg:w-[50%] border-l border-[#fccee8] p-2">
          ...
          <div className="flex gap-4 mb-6">
            <button
              ...
              className="flex-1 bg-pink-600 text-white py-2.5 rounded text-base font-medium hover:bg-pink-700 transition"
            >
              Add to Bag
            </button>
            <button
              className="flex-1 border border-pink-600 text-pink-600 py-2.5 rounded text-base font-medium hover:bg-pink-100 transition"
            >
              Wishlist
            </button>
          </div>
          ...
          <div className="mb-6 border-t pt-4">
            ...
            <div className="flex gap-2 mt-2">
              ...
              />
              <button className="text-pink-600 font-medium hover:underline">Check</button>
            </div>
          </div>

          {/* Bottom Info */}
          <div className="flex flex-wrap items-center justify-center gap-6 px-2 py-4 text-xs text-gray-600 bg-[#f4f4f5]  pt-4">
